...
function DashboardTab() {
                    ...
                    <Tabs defaultIndex={0} className=" " >
                        ...
                        <TabPanel>
                            <div className='  px-4 md:px-0 mb-16'>
                                <h1 className=' text-center mb-5 text-3xl font-semibold underline' style={{ color: mode === 'dark' ? 'white' : '' }}>All Details</h1>
 ...
 <div className="relative overflow-x-auto mb-16">
                                <h1 className=' text-center mb-5 text-3xl font-semibold underline' style={{ color: mode === 'dark' ? 'white' : '' }}>Request</h1>
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
